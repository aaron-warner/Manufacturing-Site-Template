	...
	<div id="bootstrap-touch-slider" class="carousel bs-slider fade  control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="5000" >
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item active">
                ...
                <!-- Slide Background -->
                <img src="{{ asset('img/home-image-1.jpg') }}" alt="Bootstrap Touch Slider"  class="slide-image"/>
            ...
            <div class="item">
                ...
                <div class="slide-text slide_style_center">
                    <h1 data-animation="animated flipInX">Manufacturing in the Midlands</h1>
                    <p data-animation="animated lightSpeedIn">The heart of manufacturing is right here</p>
                    <a href="/about" target="_blank" class="btn btn-default" data-animation="animated fadeInUp">About Us</a>
                    <a href="/services" target="_blank"  class="btn btn-primary" data-animation="animated fadeInDown">Our Services</a>
                </div>
            </div>
            <!-- End of Slide -->
            ...
            <div class="item">
                ...
                <!-- Slide Background -->
                <img src="{{ asset('img/home-image-3.jpg') }}" alt="Bootstrap Touch Slider"  class="slide-image"/>
                <div class="bs-slider-overlay"></div>
                <!-- Slide Text Layer -->
                <div class="slide-text slide_style_right">
                    <h1 data-animation="animated zoomInLeft">Manufacturing in the Midlands</h1>
                    <p data-animation="animated fadeInRight">The heart of manufacturing is right here</p>
                    <a href="/about" target="_blank" class="btn btn-default" data-animation="animated fadeInLeft">About Us</a>
                    <a href="/services" target="_blank" class="btn btn-primary" data-animation="animated fadeInRight">Our Services</a>
                </div>
            </div>
	    ...
	    <div class="col-xs-10 col-xs-offset-1">
		    ...
		    <div class="row home-icon-container">
		    	...
		    	<div class="col-md-4 col-sm-6">
		    		<h3><i class="fa fa-briefcase" aria-hidden="true"></i>  SERVICE</h3>
		    		<p>
		    		Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sit amet vehicula nunc.
		    		</p>
		    		<a href="#">Read more...</a>
		    	</div>

		    	<div class="col-md-4 col-sm-6">
		    		<h3><i class="fa fa-wrench" aria-hidden="true"></i>  MAINTENANCE</h3>
		    		<p>
		    		Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sit amet vehicula nunc.
		    		</p>
		    		<a href="#">Read more...</a>
		    	...
		    	<div class="col-md-4 col-sm-6">
		    		<h3><i class="fa fa-industry" aria-hidden="true"></i>  FACTORY</h3>
		    		<p>
		    		Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sit amet vehicula nunc.
		    		</p>
		    		<a href="#">Read more...</a>
		    	...
		    	<div class="col-md-4 col-sm-6">
		    		<h3><i class="fa fa-cube" aria-hidden="true"></i>  PRODUCT</h3>
		    		<p>
		    		Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sit amet vehicula nunc.
		    		</p>
		    		<a href="#">Read more...</a>
		    	...
		    	<div class="col-md-4 col-sm-6">
		    		<h3><i class="fa fa-truck" aria-hidden="true"></i>  DELIVERY</h3>
		    		<p>
		    		Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sit amet vehicula nunc.
		    		</p>
		    		<a href="#">Read more...</a>
		    	...
		    	<div class="col-md-4 col-sm-6">
		    		<h3><i class="fa fa-cog" aria-hidden="true"></i>  MANUFACTURING</h3>
		    		<p>
		    		Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sit amet vehicula nunc.
		    		</p>
		    		<a href="#">Read more...</a>
